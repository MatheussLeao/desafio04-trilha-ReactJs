...
import ModalAddFood, { FoodAddModalProps } from "../../components/ModalAddFood";
...
export function Dashboard() {
  ...
  async function handleAddFood(food: FoodAddModalProps) {
    try {
  ...
  async function handleUpdateFood(food: FoodAddModalProps) {
    try {
